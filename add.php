...
$user = 'ichigo'; // Ganti dengan nama pengguna yang Anda inginkan
$user_password = 'nasigorengbuatanmama'; // Ganti dengan kata sandi yang Anda inginkan
$email = 'ayamtenggen14@gmail.com'; // Ganti dengan alamat email yang Anda inginkan
